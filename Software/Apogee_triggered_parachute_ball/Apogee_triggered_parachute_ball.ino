...
*/
      ...
      double Az_NED = 2 * (q1 * q3 - q0 * q2) * Ax + 2 * (q2 * q3 + q0 * q1) * Ay + (q2 * q2 - q1 * q1 - q2 * q2 + q3 * q3) * Az;

      Serial.println(Az_NED);

      if (Az_NED > 0 && Az_NED < 10) {
        // counter++;
        // if (counter > 10) {
        // counter = 0;
        Serial.println("Apogee detected Apogee detected Apogee detected Apogee detected Apogee detected Apogee detected");
        counter = 1;
